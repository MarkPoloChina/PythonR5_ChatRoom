...
from .define_socket import main_socketio


@main_socketio.on('connect', namespace='/chat')
def connect():
    print('连接成功')


@main_socketio.on('joined', namespace='/chat')
...
@main_socketio.on('left', namespace='/chat')
...
@main_socketio.on('text', namespace='/chat')
